...
3. After the form is submitted there will be a JIRA ticket created with the checklist items.
...
### Populate SDL fields
1. Your Slack Username: Enter your slack name
2. Project Name: Enter some summary for your JIRA ticket
3. JIRA Epic Id: Enter the Epic Id
4. Link To Spec: Enter the link for your Epic 
